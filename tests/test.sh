...
cp "$PROJECT_DIR/download-juggler.sh" "$TEST_DIR/download-juggler.sh"
chmod +x "$TEST_DIR/download-juggler.sh"
...
"$TEST_DIR/download-juggler.sh" --once --quiet
...
test -f "$TEST_DIR/download-juggler.sh"
